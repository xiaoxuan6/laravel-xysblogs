            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="{{ session::get('avatar') ?? Admin::user()->avatar }}" class="user-image" alt="User Image">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            <img src="{{ session::get('avatar') ?? Admin::user()->avatar }}" class="img-circle" alt="User Image">

                            <p>
                                {{ Admin::user()->name }}
                                <small>最近登录时间： {{ Admin::user()->created_at }}</small>
                            </p>
                        </li>
